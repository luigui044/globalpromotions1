            ...
            <div class="col-12">
                ...
                <div class="card card-cascade narrower">
                    ...
                    <div class="view view-cascade gradient-card-header blue-gradient" style="padding: 0.6rem 1rem;">
                        <div class="row">
                            <div class="col-md-1">
                                <a href="{{ route('eventos') }}" class="text-white" data-toggle="tooltip"
                                    data-placement="top" title="Regresar a eventos">
                                    <h2> <i class="far fa-arrow-alt-circle-left"></i></h2>
                                </a>

                            </div>
                            <div class="col-md-10">
                                <h2 class="card-header-title">Asignar Localidades</h2>
                            </div>
                        </div>
                        <!-- Title -->
                    </div>
                    ...
                    <div class="card-body card-body-cascade ">
                        ...
                        <hr>
                        <div class="row">
                            <div class="col-12 col-md-8 text-center justify-content-center" id="listLocalidades">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($localEvento as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn-floating btn-sm btn-secondary" id="modalDesc"
                                                            data-toggle="tooltip" data-placement="top"
                                                            title="Programar Descuento"
                                                            onclick="mostrarModal({{ $item->id_asignacion }},{{ $item->evento }})"><i
                                                                class="fas fa-percent"></i></a>

                                                        <a class="btn-floating btn-sm btn-warning"
                                                            onclick="mostrarModalEdicion({{ $item->id_asignacion }},{{ $item->evento }})"
                                                            data-toggle="tooltip" data-placement="top"
                                                            title="Editar localidad"><i class="fas fa-edit"></i></a>
                                                        <a class="btn-floating btn-sm btn-danger"
                                                            id="desa{{ $item->id_asignacion }}"
                                                            onclick="eliminarLocal({{ $item->id_asignacion }},{{ $item->evento }})"
                                                            data-toggle="tooltip" data-placement="top"
                                                            title="Eliminar localidad"><i
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <select class="browser-default custom-select" id='localidad' name='localidad'>
                                                <option value="" selected>Seleccion una localidad</option>
                                                @foreach ($localidades as $item)
                                                    <option value="{{ $item->id_localidad }}">
                                                        {{ $item->nombre_localidad }}</option>
                                                @endforeach
                                            </select>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="">
                        ...
                        <input type="text" class="form-control mb-1" id="descuento" name="descuento"
                            placeholder="0.00%">
                        <!--Grid row-->
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="md-form">
                                    ...
                                    <input placeholder="Selected starting date" type="text" id="startingDate"
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="md-form">
                                    <!--The "to" Date Picker -->
                                    <input placeholder="Selected ending date" type="text" id="endingDate"
                                        class="form-control datepicker">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="">
                        ...
                        <input type="text" class="form-control mb-1" id="precioEdit" name="precioEdit"
                            placeholder="$0.00">
...
@section('scripts')
    ...
    <script type="text/javascript" src="{{ asset('js/setLocalidad.js') }}"></script>
@endsection
